...
import type { FeedFilter, FeedLocationSelection, FeedPost } from "@/features/guest/restaurants"
...
export default function GuestRestaurantsPage() {
    ...
    const [showFAB, setShowFAB] = useState(() => window.scrollY > FAB_SCROLL_THRESHOLD)
