...
export function toOrderEndpointError(
...
export async function listOrders(
  ...
  const response = await apiClient.get<ApiSuccessResponse<OrderListResponse>>(
    `/restaurants/${restaurantId}/orders`,
    {
...
export async function cancelOrderItem(
  ...
  const response = await apiClient.delete<
    ApiSuccessResponse<CancelOrderItemResponse>
...
export async function updateOrderStatus(
  ...
  >(`/restaurants/${restaurantId}/orders/${orderId}/status`, payload)
  return unwrapResponseData(response)
}
...
export async function updateOrderItemStatus(
  ...
  const response = await apiClient.patch<
    ApiSuccessResponse<UpdateOrderItemStatusResponse>
  >(
...
export async function updateOrderDiscount(
  restaurantId: string,
  orderId: string,
  payload: UpdateOrderDiscountPayload
): Promise<UpdateOrderDiscountResponse> {
  const response = await apiClient.patch<
    ApiSuccessResponse<UpdateOrderDiscountResponse>
  >(`/restaurants/${restaurantId}/orders/${orderId}/discount`, payload)
  return unwrapResponseData(response)
}
...
export async function cancelOrder(
  ...
  const response = await apiClient.patch<
    ApiSuccessResponse<CancelOrderResponse>
  >(`/restaurants/${restaurantId}/orders/${orderId}/cancel`, payload)
  return unwrapResponseData(response)
}
...
export async function createPublicOrder(
  ...
  const response = await apiClient.post<
    ApiSuccessResponse<CreatePublicOrderResponse>
