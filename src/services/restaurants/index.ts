...
export async function checkRestaurantSlug(
  payload: CheckRestaurantSlugPayload
): Promise<CheckRestaurantSlugResponse> {
  const response = await apiClient.post<
    ApiSuccessResponse<CheckRestaurantSlugResponse>
  >("/restaurants/check-slug", payload)
...
export async function createRestaurant(
  ...
  const response = await apiClient.post<ApiSuccessResponse<Restaurant>>(
    "/restaurants",
    payload
  )
  return unwrapResponseData(response)
...
export async function getOwnerRestaurants(
  query: OwnerRestaurantsQuery = {}
): Promise<PaginatedResponse<OwnerRestaurantListItem>> {
  const response = await apiClient.get<
    ApiSuccessResponse<PaginatedResponse<OwnerRestaurantListItem>>
  >("/restaurants", {
...
export async function getRestaurantDetail(
  restaurantId: string
): Promise<Restaurant | RestaurantStaffDetail> {
  const response = await apiClient.get<
    ApiSuccessResponse<Restaurant | RestaurantStaffDetail>
...
export async function updateRestaurantPublishStatus(
  ...
  const response = await apiClient.patch<
    ApiSuccessResponse<UpdatePublishStatusResponse>
  >(`/restaurants/${restaurantId}/publish`, payload)
  return unwrapResponseData(response)
}
...
export async function updateRestaurantOnlineOrders(
  ...
  const response = await apiClient.patch<
    ApiSuccessResponse<UpdateOnlineOrdersResponse>
  >(`/restaurants/${restaurantId}/online-orders`, payload)
  return unwrapResponseData(response)
}
...
export async function searchPublicRestaurants(
  ...
  const response = await apiClient.get<
    ApiSuccessResponse<PaginatedResponse<PublicRestaurantSearchItem>>
  >("/public/restaurants", {
    params,
  })
  return unwrapResponseData(response)
...
export async function getPublicRestaurantBySlug(
  ...
  const response = await apiClient.get<
    ApiSuccessResponse<PublicRestaurantDetail>
