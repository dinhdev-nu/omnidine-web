...
const sampleOrders: Order[] = [
    { id: "1", orderId: "ORD-001", customer: "Nguyễn Văn A", customerPhone: "0901 234 567", table: "B01", total: 450000, items: [{ id: "i1", name: "Cà phê", quantity: 2 }, { id: "i2", name: "Bánh mì", quantity: 1 }], status: "completed", paymentStatus: "paid", staff: "Trần B.", createdAt: "2024-01-20T08:30:00Z" },
    { id: "2", orderId: "ORD-002", customer: "Lê Thị B", customerPhone: "0912 345 678", table: "A03", total: 320000, items: [{ id: "i3", name: "Phở", quantity: 1 }], status: "pending", paymentStatus: "unpaid", staff: "Phạm C.", createdAt: "2024-01-20T09:15:00Z" },
    { id: "3", orderId: "ORD-003", customer: "Phạm Văn C", table: "C02", total: 780000, items: [{ id: "i4", name: "Bún bò", quantity: 2 }, { id: "i5", name: "Nước cam", quantity: 2 }, { id: "i6", name: "Tráng miệng", quantity: 1 }], status: "processing", paymentStatus: "unpaid", staff: "Nguyễn D.", createdAt: "2024-01-20T10:00:00Z" },
    { id: "4", orderId: "ORD-004", customer: "Hoàng Thị D", email: "htd@email.com", table: "D04", total: 195000, items: [{ id: "i7", name: "Trà sữa", quantity: 1 }], status: "cancelled", paymentStatus: "refunded", staff: "Lê E.", createdAt: "2024-01-19T14:30:00Z" },
    { id: "5", orderId: "ORD-005", customer: "Vũ Văn E", customerPhone: "0945 678 901", table: "B02", total: 560000, items: [{ id: "i8", name: "Lẩu nhỏ", quantity: 1 }, { id: "i9", name: "Rau", quantity: 1 }], status: "completed", paymentStatus: "paid", staff: "Trần B.", createdAt: "2024-01-19T19:00:00Z" },
    { id: "6", orderId: "ORD-006", customer: "Đặng Thị F", table: "A01", total: 240000, items: [{ id: "i10", name: "Cơm gà", quantity: 2 }], status: "completed", paymentStatus: "paid", staff: "Phạm C.", createdAt: "2024-01-18T12:00:00Z" },
    { id: "7", orderId: "ORD-007", customer: "Bùi Văn G", customerPhone: "0967 890 123", table: "C03", total: 410000, items: [{ id: "i11", name: "Mì xào", quantity: 1 }, { id: "i12", name: "Chè", quantity: 2 }], status: "pending", paymentStatus: "unpaid", staff: "Nguyễn D.", createdAt: "2024-01-18T15:30:00Z" },
    { id: "8", orderId: "ORD-008", customer: "Ngô Thị H", table: "D01", total: 890000, items: [{ id: "i13", name: "Gà nướng", quantity: 1 }, { id: "i14", name: "Hải sản", quantity: 1 }, { id: "i15", name: "Bia", quantity: 3 }], status: "completed", paymentStatus: "paid", staff: "Lê E.", createdAt: "2024-01-17T20:00:00Z" },
];
