    ...
    <div className="space-y-6">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              key={tab.id}
              onClick={() =>
                dispatchUi({ type: "setActiveTab", activeTab: tab.id })
              }
      ...
      {activeTab === "profile" && (
        <CreateRestaurantProvider
          ...
          initialImagePreviews={getRestaurantInitialImagePreviews(
            restaurantDetail
          )}
        >
        ...
        <>
          <Card className="border-border bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Hành động này sẽ xóa vĩnh viễn dữ liệu nhà hàng và không thể
                hoàn tác
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-4">
                <p className="text-sm text-muted-foreground">
                  Khi xóa nhà hàng, toàn bộ thông tin hồ sơ, menu, đơn hàng và
                  dữ liệu liên quan sẽ bị gỡ bỏ khỏi hệ thống.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    dispatchUi({
                      type: "setDeleteRestaurantConfirmText",
