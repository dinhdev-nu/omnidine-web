...
type MobileOrderItem = NonNullable<Order["items"]>[number]

function OrderMobileHeader({
  order,
  highlighted,
  expanded,
  onToggleExpand,
...
function MobileOrderInfo({ detailOrder }: MobileDetailSectionProps) {
  return (
    <>
...
function MobileOrderNotes({ detailOrder }: MobileDetailSectionProps) {
  return (
    <>
      {detailOrder.notes && (
...
interface OrderMobileExpandedDetailsProps extends Omit<
  MobileDetailSectionProps,
  "detailOrder"
> {
  detailOrder?: Order | null
...
function OrderMobileExpandedDetails({
  order,
  detailOrder,
  isLoadingDetail,
  items,
