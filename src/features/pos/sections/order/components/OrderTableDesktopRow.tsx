...
function OrderDesktopSummaryRow({
  order,
  highlighted,
  expanded,
  onToggleExpand,
...
interface OrderDesktopDetailProps {
  order: Order
  detailOrder: Order
  isActionable: boolean
...
function OrderDesktopDetailMain({
  order,
  detailOrder,
  isActionable,
  onUpdateOrderItemStatus,
...
function OrderDesktopDetailSidebar({
  order,
  detailOrder,
  isActionable,
  discountAmount,
...
interface OrderDesktopExpandedRowProps extends Omit<
  OrderDesktopDetailProps,
  "detailOrder"
> {
  detailOrder?: Order | null
...
function OrderDesktopExpandedRow({
  order,
  detailOrder,
  isLoadingDetail,
  isActionable,
