...
export function ListRestaurantsSection() {
  ...
  const [shareTarget, setShareTarget] =
    useState<OwnerRestaurantListItem | null>(null)
  ...
  const openShareDialog = (restaurant: OwnerRestaurantListItem) => {
    setShareMode("public")
  ...
  return (
    <div>
                ...
                <CardContent className="flex h-full flex-col p-5">
                  ...
                  <div className="mt-4 flex items-center gap-2 border-t border-border pt-4">
                    ...
                    <Button
                      ...
                      onClick={() => openShareDialog(restaurant)}
                    >
      ...
      <Dialog
        ...
        onOpenChange={(isOpen) => !isOpen && setShareTarget(null)}
      >
        <DialogContent className="sm:max-w-md" showCloseButton={false}>
          ...
          <div className="grid gap-4 py-2">
            <Tabs
              value={shareMode}
              onValueChange={(value) =>
                setShareMode(value === "pos" ? "pos" : "public")
              }
            >
